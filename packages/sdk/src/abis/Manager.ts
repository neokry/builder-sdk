export const abi = [
  {
    inputs: [
      { internalType: "address", name: "_tokenImpl", type: "address" },
      { internalType: "address", name: "_metadataImpl", type: "address" },
      { internalType: "address", name: "_auctionImpl", type: "address" },
      { internalType: "address", name: "_treasuryImpl", type: "address" },
      { internalType: "address", name: "_governorImpl", type: "address" },
    ],
  ...
  { inputs: [], name: "FOUNDER_REQUIRED", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      {
        components: [
          { internalType: "bytes", name: "initStrings", type: "bytes" },
        ],
    ...
    outputs: [
      ...
      { internalType: "address", name: "metadata", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_upgradeImpl", type: "address" },
    ],
